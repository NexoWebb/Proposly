    ...
    <div style={{ minHeight: '100vh', background: pageBg, fontFamily: 'sans-serif', color: ink }}>
      ...
      <div style={{ maxWidth: '680px', margin: '0 auto', padding: '48px 24px 80px' }}>
        ...
        <div style={{ background: cardBg, border: `1px solid ${border}`, borderRadius: '16px', padding: '28px', marginBottom: '16px', backdropFilter: 'blur(8px)' }}>
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              <div onClick={() => fileRef.current?.click()}
                style={{ width: '72px', height: '72px', borderRadius: '10px', border: `1px dashed ${border}`, background: 'rgba(255,255,255,0.6)', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', overflow: 'hidden', flexShrink: 0 }}>
                {currentLogo
          ...
          {profileMsg && <p style={{ fontSize: '13px', color: profileMsg.startsWith('✓') ? '#4A9B6F' : '#C4624A', marginBottom: '12px' }}>{profileMsg}</p>}
        ...
        <div style={{ background: cardBg, border: `1px solid ${border}`, borderRadius: '16px', padding: '28px', backdropFilter: 'blur(8px)' }}>
          ...
          {passwordMsg && <p style={{ fontSize: '13px', color: passwordMsg.startsWith('✓') ? '#4A9B6F' : '#C4624A', marginBottom: '12px' }}>{passwordMsg}</p>}
